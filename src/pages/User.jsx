...
import { RepoList } from '../components/componentExport';
const User = () => {
  const { user, loading, dispatch, repos } = useGithubContext();
  ...
  useEffect(() => {
    ...
    const fetchSingleUser = async () => {
      ...
      dispatch({ type: Actions.GET_USER_AND_REPOS, payload: { user, repos } });
    };
    fetchSingleUser();
